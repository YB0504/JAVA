...
<body>
		<form method="post" action="joinChk.jsp">
			<table border=1 width=300 height=250 align="center">
				...
				<tr>
					...
					<td bgcolor="yellow"><input type="radio" name="sex" value="남자"
						checked><font size=2>남자</font> <input type="radio"
						name="sex" value="여자"><font size=2>여자</font></td>
				</tr>
				<tr>
