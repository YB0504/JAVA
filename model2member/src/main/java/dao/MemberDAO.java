...
public class MemberDAO {
	...
	public int update(MemberDTO member) {
		...
		try {
			...
			sql = "update model2member set name = ?, jumin1 = ?, jumin2 = ?,";
			sql += " mailid = ?, domain = ?, tel1 = ?, tel2 = ?, tel3 = ?,";
			sql += " phone1 = ?, phone2 = ?, phone3 = ?, post = ?, address = ?,";
	...
	public int delete(String id) {
		...
		try {
			...
			sql = "delete from model2member where id = ?";
